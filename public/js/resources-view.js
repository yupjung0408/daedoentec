...
function renderPrevNext(no) {
    ...
    if (prev) {
        document.querySelector('.resources-view-prev').innerHTML = `
            <button class="view-prev-btn" onclick="location.href='/cs/resources-view/?no=${prev.no}'">이전글</button>
    ...
    if (next) {
        document.querySelector('.resources-view-next').innerHTML = `
            <button class="view-next-btn" onclick="location.href='/cs/resources-view/?no=${next.no}'">다음글</button>
